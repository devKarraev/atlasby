...
const fetchData = async () => {
    const response = await fetch('https://atlasbus.by/api/search?from_id=c625144&to_id=c625665&calendar_width=30&date=2021-07-23&passengers=1')
